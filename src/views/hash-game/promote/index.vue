  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      <el-form-item label="玩家邀请码" prop="invitationCode">
        <el-input v-model="queryParams.invitationCode" placeholder="请输入玩家的邀请码" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="上级玩家id" prop="fatherUserId">
        <el-input v-model="queryParams.fatherUserId" placeholder="请输入上级玩家id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['hash-game:promote:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" @sort-change="sortChange" :data="promoteList" @selection-change="handleSelectionChange" height="600">
      ...
      <el-table-column label="usdt昨日收益" align="center" prop="incomeUsdtYesterday" width="200" sortable>
        <template slot-scope="scope">
          <div>{{ scope.row.incomeUsdtYesterday.toFixed(2) }}</div>
        </template>
      </el-table-column>
      <el-table-column label="usdt直推收益" align="center" prop="incomeUsdtDirectPromote" width="200" sortable>
        <template slot-scope="scope">
      ...
      <el-table-column label="trx昨日收益" align="center" prop="incomeTrxYesterday" width="200" sortable>
        <template slot-scope="scope">
          <div>{{ scope.row.incomeTrxYesterday.toFixed(2) }}</div>
        </template>
      </el-table-column>
      <el-table-column label="trx直推收益" align="center" prop="incomeTrxDirectPromote" width="200" sortable>
        <template slot-scope="scope">
          <div>{{ scope.row.incomeTrxDirectPromote.toFixed(2) }}</div>
        </template>
      </el-table-column>
      <el-table-column label="可提现usdt" align="center" prop="canWithdrawUsdtAmount" width="200" sortable>
        <template slot-scope="scope">
          <div>{{ scope.row.canWithdrawUsdtAmount.toFixed(2) }}</div>
        </template>
      </el-table-column>
      <el-table-column label="可提现trx" align="center" prop="canWithdrawTrxAmount" width="200" sortable>
        <template slot-scope="scope">
      ...
      <el-table-column label="usdt代理返佣" align="center" prop="usdtPromoteBrokerageToFather" width="200" sortable>
        <template slot-scope="scope">
          <div>{{ scope.row.usdtPromoteBrokerageToFather.toFixed(2) }}</div>
        </template>
      </el-table-column>
      <el-table-column label="trx游戏返佣" align="center" prop="trxGameBrokerageToFather" width="200" sortable>
        <template slot-scope="scope">
          <div>{{ scope.row.trxGameBrokerageToFather.toFixed(2) }}</div>
        </template>
      </el-table-column>
      <el-table-column label="trx代理返佣" align="center" prop="trxPromoteBrokerageToFather" width="200" sortable>
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="玩家的邀请码" prop="invitationCode"><el-input v-model="form.invitationCode" placeholder="请输入玩家的邀请码" /></el-form-item>
        <el-form-item label="上级玩家id" prop="fatherUserId"><el-input v-model="form.fatherUserId" placeholder="请输入上级玩家id" /></el-form-item>
        <el-form-item label="上级玩家的邀请码" prop="fatherInvitationCode"><el-input v-model="form.fatherInvitationCode" placeholder="请输入上级玩家的邀请码" /></el-form-item>
        <el-form-item label="usdt总收益" prop="incomeUsdtAmount"><el-input v-model="form.incomeUsdtAmount" placeholder="请输入usdt总收益" /></el-form-item>
        <el-form-item label="usdt今日收益" prop="incomeUsdtToday"><el-input v-model="form.incomeUsdtToday" placeholder="请输入usdt今日收益" /></el-form-item>
        <el-form-item label="usdt昨日收益" prop="incomeUsdtYesterday"><el-input v-model="form.incomeUsdtYesterday" placeholder="请输入usdt昨日收益" /></el-form-item>
        <el-form-item label="usdt直推收益" prop="incomeUsdtDirectPromote"><el-input v-model="form.incomeUsdtDirectPromote" placeholder="请输入usdt直推收益" /></el-form-item>
        <el-form-item label="trx总收益" prop="incomeTrxAmount"><el-input v-model="form.incomeTrxAmount" placeholder="请输入trx总收益" /></el-form-item>
        <el-form-item label="trx今日收益" prop="incomeTrxToday"><el-input v-model="form.incomeTrxToday" placeholder="请输入trx今日收益" /></el-form-item>
        <el-form-item label="trx昨日收益" prop="incomeTrxYesterday"><el-input v-model="form.incomeTrxYesterday" placeholder="请输入trx昨日收益" /></el-form-item>
        <el-form-item label="trx直推收益" prop="incomeTrxDirectPromote"><el-input v-model="form.incomeTrxDirectPromote" placeholder="请输入trx直推收益" /></el-form-item>
        <el-form-item label="可提现的usdt金额" prop="canWithdrawUsdtAmount"><el-input v-model="form.canWithdrawUsdtAmount" placeholder="请输入可提现的usdt金额" /></el-form-item>
        <el-form-item label="可提现的trx金额" prop="canWithdrawTrxAmount"><el-input v-model="form.canWithdrawTrxAmount" placeholder="请输入可提现的trx金额" /></el-form-item>
        <el-form-item label="一级代理人数" prop="level1Person"><el-input v-model="form.level1Person" placeholder="请输入一级代理人数" /></el-form-item>
        <el-form-item label="二级代理人数" prop="level2Person"><el-input v-model="form.level2Person" placeholder="请输入二级代理人数" /></el-form-item>
        <el-form-item label="三级代理人数" prop="level3Person"><el-input v-model="form.level3Person" placeholder="请输入三级代理人数" /></el-form-item>
