<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="88px">
      ...
      <el-form-item label="赔率" prop="odds"><el-input v-model="queryParams.odds" placeholder="请输入赔率" clearable @keyup.enter.native="handleQuery" /></el-form-item>
      ...
      <el-form-item label="到账结果" prop="rewardStatus">
        <el-select v-model="queryParams.rewardStatus" placeholder="请选择到账结果" clearable>
          <el-option v-for="dict in dict.type.reward_status" :key="dict.value" :label="dict.label" :value="dict.value" />
        </el-select>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['hash-game:record:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="游戏配置id" prop="configId"><el-input v-model="form.configId" placeholder="请输入游戏配置id" /></el-form-item>
        <el-form-item label="游戏id" prop="gameId"><el-input v-model="form.gameId" placeholder="请输入游戏id" /></el-form-item>
        <el-form-item label="场次id" prop="sessionId"><el-input v-model="form.sessionId" placeholder="请输入场次id" /></el-form-item>
        ...
        <el-form-item label="赔率" prop="odds"><el-input v-model="form.odds" placeholder="请输入赔率" /></el-form-item>
        <el-form-item label="投注类型" prop="betWalletType">
          <el-select v-model="form.betWalletType" placeholder="请选择投注的钱包类型">
            <el-option v-for="dict in dict.type.wallet_type" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="投注金额" prop="betAmount"><el-input v-model="form.betAmount" placeholder="请输入投注金额" /></el-form-item>
        <el-form-item label="投注位置" prop="betPosition"><el-input v-model="form.betPosition" placeholder="请输入投注位置" /></el-form-item>
        ...
        <el-form-item label="手续费" prop="taxAmount"><el-input v-model="form.taxAmount" placeholder="请输入手续费" /></el-form-item>
        <el-form-item label="hash值" prop="hashValue"><el-input v-model="form.hashValue" placeholder="请输入hash值" /></el-form-item>
        <el-form-item label="下注结果" prop="betResult">
          <el-select v-model="form.betResult" placeholder="请选择下注结果">
            <el-option v-for="dict in dict.type.bet_result" :key="dict.value" :label="dict.label" :value="parseInt(dict.value)"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="到账结果" prop="rewardStatus">
          <el-select v-model="form.rewardStatus" placeholder="请选择到账结果">
            <el-option v-for="dict in dict.type.reward_status" :key="dict.value" :label="dict.label" :value="parseInt(dict.value)"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="赢家" prop="winner">
          <el-select v-model="form.winner" placeholder="请选择赢家">
            <el-option v-for="dict in dict.type.winner" :key="dict.value" :label="dict.label" :value="parseInt(dict.value)"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="游戏汇总" prop="gameCollect"><el-input v-model="form.gameCollect" placeholder="请输入本局游戏汇总" /></el-form-item>
      </el-form>
