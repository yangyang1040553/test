<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="88px">
      <el-form-item label="ID" prop="id"><el-input v-model="queryParams.id" placeholder="请输入id" clearable @keyup.enter.native="handleQuery" /></el-form-item>
      ...
      <el-form-item label="提现金额" prop="withdrawAmount">
        <el-input v-model="queryParams.withdrawAmount" placeholder="请输入提现金额" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-table v-loading="loading" @sort-change="sortChange" :data="widthdrawRecordList" @selection-change="handleSelectionChange" height="600">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="提现金额" prop="withdrawAmount"><el-input v-model="form.withdrawAmount" placeholder="请输入提现金额" /></el-form-item>
        <el-form-item label="钱包类型" prop="walletType">
        ...
        <el-form-item label="提现后剩余金额" prop="afterAmount"><el-input v-model="form.afterAmount" placeholder="请输入提现后剩余金额" /></el-form-item>
        <el-form-item label="提现状态 1成功 2转入钱包异常" prop="status">
          <el-select v-model="form.status" placeholder="请选择提现状态 1成功 2转入钱包异常">
            <el-option v-for="dict in dict.type.withdraw_status" :key="dict.value" :label="dict.label" :value="parseInt(dict.value)"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
