  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="128px">
      ...
      <el-form-item :label="$t('dictionary_type')" prop="dictType">
        <el-input v-model="queryParams.dictType" :placeholder="$t('enter_dictionary_type')" clearable
          style="width: 240px" @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:dict:add']">{{ $t('new') }}</el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-refresh" size="mini" @click="handleRefreshCache"
          v-hasPermi="['system:dict:remove']">{{ $t('flush_cache') }}</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="140px">
        <el-form-item :label="$t('dictionary_name')" prop="dictName">
          <el-input v-model="form.dictName" :placeholder="$t('enter_dictionary_name')" />
        </el-form-item>
        <el-form-item :label="$t('dictionary_type')" prop="dictType">
          <el-input v-model="form.dictType" :placeholder="$t('enter_dictionary_type')" />
        </el-form-item>
        <el-form-item :label="$t('status')" prop="status">
