  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="88px">
      ...
      <el-form-item label="trx余额" prop="trxAmount">
        <el-input v-model="queryParams.trxAmount" placeholder="请输入trx余额" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="Usdt地址" prop="hashAddressUsdt">
        <el-input v-model="queryParams.hashAddressUsdt" placeholder="请输入Usdt的hash地址" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="Trx地址" prop="hashAddressTrx">
        <el-input v-model="queryParams.hashAddressTrx" placeholder="请输入Trx的hash地址" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="总充值金额" prop="rechargeTotal">
        <el-input v-model="queryParams.rechargeTotal" placeholder="请输入总充值金额" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="总提现金额" prop="withdrawTotal">
        <el-input v-model="queryParams.withdrawTotal" placeholder="请输入总提现金额" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['hash-wallet:management:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['hash-wallet:management:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="managementList" @selection-change="handleSelectionChange" height="600">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-detail" @click="handleUpdate(scope.row)"
            v-hasPermi="['hash-wallet:management:edit']">详情</el-button>
