<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="注册时间" align="center" prop="registerTime" width="180"></el-table-column>
      <el-table-column label="账户绑定时间" align="center" prop="bindTime" width="180"></el-table-column>
      <el-table-column label="注册ip" align="center" prop="registerIp" />
      <el-table-column label="登录时间" align="center" prop="loginTime" width="180"></el-table-column>
