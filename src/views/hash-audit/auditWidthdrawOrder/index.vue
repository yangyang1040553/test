  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="提现的金额" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入提现的金额" />
        </el-form-item>
        <el-form-item label="矿工费" prop="minerAmount">
          <el-input v-model="form.minerAmount" placeholder="请输入矿工费" />
        </el-form-item>
        <el-form-item label="状态  0：处理中 1：失败  2：拒绝  3：已完成 " prop="status">
          <el-select v-model="form.status" placeholder="请选择状态  0：处理中 1：失败  2：拒绝  3：已完成 ">
            <el-option
              v-for="dict in dict.type.order_status"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="审核状态 0：待审核 1：审核中 2：审核拒绝3：审核完成" prop="checkStatus">
          <el-select v-model="form.checkStatus" placeholder="请选择审核状态 0：待审核 1：审核中 2：审核拒绝3：审核完成">
            <el-option
              v-for="dict in dict.type.check_status"
              :key="dict.value"
              :label="dict.label"
